...
HD_PWD='C:/Users/yohan/Desktop/gtp_5g_test/gtp_5g_test.runs/gtp_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gtp.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gtp.tcl

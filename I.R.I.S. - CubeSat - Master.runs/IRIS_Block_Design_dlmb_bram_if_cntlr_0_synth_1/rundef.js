...
ISEStep( "vivado",
         "-log IRIS_Block_Design_dlmb_bram_if_cntlr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IRIS_Block_Design_dlmb_bram_if_cntlr_0.tcl" );
